export default {
  ...
  files: {
    ...
    status: {
      ...
      description: {
        ...
        processing: "テキストを抽出中…",
        ready: "テキストを抽出し検索可能",
        readyNoText: "このファイルに抽出可能なテキストはありません",
        error: "テキスト抽出に失敗しました",
      },
    },
    info: {
  ...
  settings: {
    ...
    account: {
      ...
      sessions: {
        title: "セッション",
        description: "アカウントにログインしているデバイスとアプリ。",
        current: "このデバイス",
        lastUsed: "最終使用",
        logout: "ログアウト",
        logoutThis: "このデバイスをログアウト",
        logoutOthers: "他をログアウト",
        renamed: "セッション名を変更しました",
        loggedOut: "セッションをログアウトしました",
        loggedOutOthers: "他のセッションをログアウトしました",
