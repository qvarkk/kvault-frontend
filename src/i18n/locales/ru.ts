export default {
  ...
  validation: {
    username: {
      ...
      max: "Имя пользователя должно содержать не более {max} символов",
    },
    password: {
  ...
  notes: {
    ...
    tags: {
      ...
      typeToAdd: "Введите название, чтобы добавить теги",
    ...
    trash: {
      ...
      emptyConfirm: {
        ...
        description:
          "Все элементы будут удалены навсегда. Это действие необратимо.",
  ...
  files: {
    ...
    trash: {
      ...
      emptyConfirm: {
        title: "Очистить корзину?",
        description:
          "Все файлы будут удалены навсегда. Это действие необратимо.",
        action: "Очистить корзину",
      },
