export default {
  ...
  search: {
    placeholder: "Поиск по заметкам и файлам…",
    notes: "Заметки",
    files: "Файлы",
  ...
  files: {
    ...
    status: {
      ...
      description: {
        ...
        readyNoText: "В этом файле нет извлекаемого текста",
  ...
  settings: {
    ...
    account: {
      ...
      sessions: {
        title: "Сеансы",
        description: "Устройства и приложения, вошедшие в ваш аккаунт.",
        current: "Это устройство",
        lastUsed: "Последний вход",
        logout: "Выйти",
        logoutThis: "Выйти с этого устройства",
        logoutOthers: "Выйти на других",
        renamed: "Сеанс переименован",
        loggedOut: "Сеанс завершён",
        loggedOutOthers: "Другие сеансы завершены",
